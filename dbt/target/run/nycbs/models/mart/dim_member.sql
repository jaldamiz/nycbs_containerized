    ...
    create  table
      "test"."raw_mart"."dim_member__dbt_tmp"
  ...
  (
    ...
    has_unlimited_rides boolean,
    has_priority_booking boolean,
    max_ride_duration_minutes integer,
    is_current boolean,
    valid_from date,
    valid_to date
 ...
 ;
    insert into "test"."raw_mart"."dim_member__dbt_tmp" 
  (
 ...
 (
    ...
    select member_id, member_casual, membership_description, membership_tier, price_multiplier, has_unlimited_rides, has_priority_booking, max_ride_duration_minutes, is_current, valid_from, valid_to
    from (
