    ...
    create  table
      "test"."raw_mart"."dim_station__dbt_tmp"
  
  (
    station_id varchar,
    original_station_id varchar,
 ...
 ;
    insert into "test"."raw_mart"."dim_station__dbt_tmp" 
  (
 ...
 (
    ...
    select station_id, original_station_id, station_name, latitude, longitude, station_type, capacity, is_electric
    from (
