    ...
    create  table
      "test"."raw_mart"."dim_bike__dbt_tmp"
  
  (
    rideable_type_id varchar,
    rideable_type varchar,
    bike_type_description varchar,
    propulsion_category varchar,
    has_electric_assist boolean,
    requires_docking boolean,
    maintenance_interval_days integer,
    price_multiplier decimal(2,1),
    is_current boolean,
    valid_from date,
    valid_to date
 ...
 ;
    insert into "test"."raw_mart"."dim_bike__dbt_tmp" 
  (
 ...
 (
    ...
    select rideable_type_id, rideable_type, bike_type_description, propulsion_category, has_electric_assist, requires_docking, maintenance_interval_days, price_multiplier, is_current, valid_from, valid_to
    from (
